...
Route::get('/admin-them-DanhMucSP','App\Http\Controllers\DanhMucSanPham@them_DanhMucSP' );
Route::post('/luu_danhmucSP','App\Http\Controllers\DanhMucSanPham@luu_danhmucSP' );

// admin_ liet ke danh muc san pham
Route::get('/admin-lietke-DanhMucSP','App\Http\Controllers\DanhMucSanPham@lietke_DanhMucSP' );

// admin - sua danh muc san pham
Route::get('/admin-sua-DanhMucSP/{id_DanhMuc}','App\Http\Controllers\DanhMucSanPham@sua_danhmucSP' );

// admin - xoa danh muc san pham
Route::get('/admin-xoa-DanhMucSP/{id_DanhMuc}','App\Http\Controllers\DanhMucSanPham@xoa_danhmucSP' );

// admin - cap nhat danh muc san pham
Route::post('/admin-capnhat-danhmucSP/{id_DanhMuc}','App\Http\Controllers\DanhMucSanPham@capnhat_danhmucSP' );
