            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5" >
                    <div class="card-body p-0" >
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image"><img style="width: 451px;
                                 height: 420px;" src="{{asset('public/backend/img/admin.png')}}" ></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4" style="font-weight: 700">Đăng Nhập</h1>
                                    </div>
                                    ...
                                    <form class="user" action="{{URL::to('/admin-Dashboard')}}" method="post">
                                          {{csrf_field()}}   <!-- sinh ra 1 html input   -->
                                        ...
                                        <input type="submit" name="login" value="Đăng nhập" class="btn btn-primary btn-user btn-block">
                                    ...
                                    <hr>
                                    {{-- <div class="text-center">
                                        <a class="small" href="{{url('/admin-login-QTV')}}">
                                        Đăng nhập - Quản trị viên</a>
                                        <br>
                                        <a class="small" href="{{url('/admin-dang-ky-tai-khoan')}}">Đăng ký tài khoản</a>
