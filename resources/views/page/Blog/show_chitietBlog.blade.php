            ...
            <div class="col-lg-9 col-md-12 product-default-item">
                ...
                <div class="feature-products tab-content">
                    ...
                    <div id="grid" class="tab-pane active">
                        <div class="product">
                            <div class="row">
                                @foreach($chitiet_blog as $key=>$chitiet)

                                <span style="font-size: 30px;font-family: 'Flaticon';margin-bottom: 3rem;color: #91ad41;font-weight: 800; margin-left: 4rem;">{{$chitiet->TenBaiViet}}</span>

                                <span style="color: black;margin-left: 4rem;">{!!$chitiet->NoiDungBaiViet!!}</span>
