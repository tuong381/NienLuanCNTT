            ...
            <div class="col-lg-9 col-md-12 product-default-item">
                ...
                <div class="title-default custom-counter d-flex justify-content-between w-100 flex-wrap">
                    ...
                    <div class="content-left d-flex justify-content-start align-items-center">
                        ...
                        <div class="product-counter" style="margin-bottom: 2rem; color: black">Danh mục bài viết : <span class="color-default">{{$ten->TenDanhMucBaiViet}}</span>
                        </div>
                        @endforeach
                ...
                <div class="feature-products tab-content">
                    ...
                    <div id="grid" class="tab-pane active">
                        <div class="product">
                            <div class="row">
                                @foreach($danhmuc_id as $key=>$danhmuc)
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                    <div class="item item-hover-view-cart">

                                        <input type="hidden" name="idBaiViet_hidden" value="{{$danhmuc->id_BaiViet}}">

                                            <div class="product-thumb">
                                                <div class="product-container item-img">
                                                    <div class="product-image-container"><a class="product-img-link" href="{{URL::to('/show-chi-tiet-Blog/'.$danhmuc->id_BaiViet)}}" title=""><img class="img-fluid"
                                                    src="{{URL::to('public/upload/baiviet/'.$danhmuc->HinhAnh_BaiViet
                                                    )}}" alt="img" style="height:200px"><img class="img-fluid img-hover"
                                                    src="{{URL::to('public/upload/baiviet/'.$danhmuc->
                                                    HinhAnh_BaiViet)}}" alt="img" style="height: 230px"></a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="product-info text-center" style="height: 8rem">
                                                <h4 class="product-name"><a href="{{URL::to('/show-chi-tiet-Blog/'.$danhmuc->id_BaiViet)}}">{{$danhmuc->TenBaiViet}}</a></h4>
                                                <div class="article-info">{{$danhmuc->created_at}}
                                                </div>
                                            </div>
