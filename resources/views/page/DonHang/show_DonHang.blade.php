                        ...
                        <div class="row">
                                    ...
                                    <div class="item-content">
                                        <div class="sub-title">
                                            <h4 ><a href="{{URL::to('/xem-danh-sach-don-hang')}}"
                                                style="color: chocolate">Tất cả đơn hàng</a></h4>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 mg-bottom-50" style="max-width: 20%;">
                                <div class="item">
                                    ...
                                    <div class="item-content">
                                        <div class="sub-title">
                                            <h4><a href="{{URL::to('/xem-danh-sach-don-hang-4')}}" style="color: black">Đã xác nhận</a></h4>
                                        </div>
                          ...
                          <tr >
                            ...
                            <td>
                                ...
                                @elseif($show->TrangThaiHoaDon == 2)
                                     Đang giao
                                @elseif($show->TrangThaiHoaDon == 3 || $show->TrangThaiHoaDon == 5)
                                    Đã hủy
